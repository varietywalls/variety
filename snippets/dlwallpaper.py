...
class WallpapersNetScraper():
    ...
    def download_one(self):
        ...
        localFile = open(os.path.join(self.target_dir, name), 'w')
        localFile.write(u.read())
        localFile.close()

        localFile = open(os.path.join(self.target_dir, name + ".txt"), 'w')
        localFile.write(wallpaper_url)
        localFile.close()

if __name__ == '__main__':
    WallpapersNetScraper("http://wallpapers.net/nature-desktop-wallpapers.html", "/home/peter/.variety/downloaded").download_one()